...
public class Login extends javax.swing.JFrame {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(register, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
                    .addComponent(password, javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(notify, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        ...
        if (username.getText().isEmpty() || password.getText().isEmpty()) {
            ...
            String getPassword = db.getPasswordByUserName(username.getText());
            Helper.HelperArgon2 argon2 = new HelperArgon2();
            if (getPassword != null && argon2.verify(getPassword, password.getPassword())) {
                ...
                if (jCheckBox1.isSelected()) {
                    ...
                    Helper.WrSettings.setProperty("sessionID", uuid.toString());
                    db.createSession(argon2.hash(uuid.toString().toCharArray()));
                }

            } else {
                notify.setText("Incorrect username or password.");
            }
        }
